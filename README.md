...
# bitcore-wallet-service-dinero

[![NPM Package](https://img.shields.io/npm/v/bitcore-wallet-service-dinero.svg?style=flat-square)](https://www.npmjs.org/package/bitcore-wallet-service-dinero)
[![Build Status](https://img.shields.io/travis/dinerocoin/bitcore-wallet-service-dinero.svg?branch=master&style=flat-square)](https://travis-ci.org/dinerocoin/bitcore-wallet-service-dinero)
[![Coverage Status](https://coveralls.io/repos/dinerocoin/bitcore-wallet-service-dinero/badge.svg?branch=master)](https://coveralls.io/r/dinerocoin/bitcore-wallet-service-dinero?branch=master)
...
# Getting Started
```
 git clone https://github.com/dinerocoin/bitcore-wallet-service-dinero.git
 cd bitcore-wallet-service-dinero && npm start
```
